      ...
      <section className="flex justify-center flex-wrap">
        {carData.map((car, i) => {
          return (
              ...
              <div key={i} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 m-4 h-[300px] bg-white rounded-lg p-2">
                <figure>
                  <img
                    src={car.imgUrl}
                    alt={car.carName}
                ...
                <div className="car_details">
                  ...
                  <div className="flex justify-between my-1">
                    ...
                    <div className="flex items-center">
                      <span className="text-blue-500 mx-2 bg-emerald-200 p-1 rounded-lg"><AiOutlineHeart/></span>
                      <button className="text-white bg-blue-500 px-3 py-1 rounded-lg text-sm hover:bg-gray-200 hover:text-blue-500">Rent now</button>
                    </div>
                  </div>
                </div>
              </div>
